...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-6">
        ...
        <a href="edit-produits.jsp" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add New Product</a>
            ...
            <tbody>
                <c:forEach var="Produits" items="${listProduits}">
                    <tr class="border-t">
                        ...
                        <td class="px-6 py-3">
                            <a href="ProduitsServlet?action=edit&id=${Produits.id}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit</a>
                            <a href="ProduitsServlet?action=delete&id=${Produits.id}" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 ml-2">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
